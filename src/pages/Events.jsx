...
export const Events = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-3xl shadow-xl">
        ...
        <div className="space-y-4 max-h-[420px] overflow-y-auto pr-1">
          {events.slice(0, 8).map((event, index) => (
            <div
              ...
              className={`flex gap-3 p-3 rounded-xl cursor-pointer transition shadow-sm ${
                featured === index
